...
marlin_download_url = f"https://github.com/MarlinFirmware/Marlin/archive/{bugfix}{download_version}.zip"
...
print(f"Downloading version {download_version} from {marlin_download_url} to {download_zip_filepath}...")
